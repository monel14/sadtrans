...
export class AgentRequestRechargeModal extends BaseModal {
    ...
    constructor() {
        super('agentRequestRechargeModal', { size: 'lg' });
        this.render();
    ...
    private render() {
        ...
        footer.innerHTML = `
            ...
            <button type="submit" form="agentRechargeForm" class="btn btn-primary">Enregistrer et Soumettre</button>
        `;

        this.setContent(title, body, footer);
        this.form = $('#agentRechargeForm', this.modalElement) as HTMLFormElement;
    }
