// Service Worker SadTrans - Version nettoyée
// Gestion du cache, support hors ligne, synchronisation en arrière-plan et notifications push natives

// Configuration du service worker
const CACHE_NAME = 'sadtrans-v2.0.0';
const OFFLINE_URL = '/offline.html';
const API_CACHE_NAME = 'sadtrans-api-v2.0.0';
...
console.log('🚀 Service Worker SadTrans (Clean) chargé');
  ...
  if (event.action === 'explore') {
    ...
    event.waitUntil(
      clients.matchAll({ type: 'window' }).then(clientList => {
        ...
        // Si aucune fenêtre trouvée, ouvrir une nouvelle fenêtre
...
console.log('✅ Service Worker SadTrans (Clean) configuré avec succès');